...
const generateGalaxy = () => {
    ...
    // destroy old galaxy for memory cleanup
    if (points !== null) {
        geometry.dispose()
        material.dispose()
        scene.remove(points)
    ...
    const positions = new Float32Array(parameters.count * 3) // because of XYZ
    const colors = new Float32Array(parameters.count * 3) // because of RGB
